...
pvnet_pivot_df = filtered_pvnet_df.pivot(
    index="forecast_init_time", columns="horizon_mins", values="hindcast"
)
...
pvnet_pivot_df.to_csv(
    "../../data/pvnet_predicitons_2021-2023_preformat_v2.csv", index=False
)
