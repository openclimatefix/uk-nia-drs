...
# Pivot the DataFrame
pivot_df = data_stack.pivot_table(index=['forecasting_creation_datetime_utc', 'start_datetime_utc', 'end_datetime_utc'], 
                          columns='forecast', 
                          values='generation_mw',
                          aggfunc='first')  

# Rename the columns if necessary
pivot_df.rename(columns={'pred': 'generation_mw', 'p10': 'generation_mw_p10', 'p90': 'generation_mw_p90'}, inplace=True)
